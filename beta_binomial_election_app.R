...
##
## Your answer:
## alpha = 171.5, beta = 115.5, mean = 0.598, 95% credible interval is
## 54% and 65%
## ------------------------------------------------------------
...
##
## Your answer:The mean stays the same because of the ratio.
## The width of the 95% credible interval shrinks between 40% and 50%.
## The mean doesn't move but the interval does because of the sample size.
## Due to the larger sample size the interval becomes smaller.
## ------------------------------------------------------------
...
##
## Your answer:
## Mean = 0.500, Mode = no single mode, SD = 0.289 
## Mean = 0.500, Mode = no single mode, SD = 0.354
## having one prior isn't enough data. it's more dense on the end making it fold in on itself
## ------------------------------------------------------------
...
##
## Your answer:
## it's closer to our posterior.
## the amount of data has to be several times larger than the confident prior.
## ------------------------------------------------------------
